...
if __name__ == "__main__":
  ...
  uds_client = UdsClient(panda, 0x726, bus=args.bus, debug=args.debug)

  print("\n[START DIAGNOSTIC SESSION]")
  uds_client.communication_control(uds.CONTROL_TYPE.ENABLE_RX_DISABLE_TX, uds.MESSAGE_TYPE.NORMAL)
  # uds_client.diagnostic_session_control(SESSION_TYPE.EXTENDED_DIAGNOSTIC)

  print("[HARDWARE/SOFTWARE VERSION]")
  fw_version_data_id : DATA_IDENTIFIER_TYPE = 0xf180 # type: ignore
